Quickie is a "quicklaunch" bar based off "LibDataBroker-1.1":http://github.com/tekkub/libdatabroker-1-1 and "Auctionner's":http://auctioneeraddon.com Slidebar.
...
Examples on how to register a button in your own addon will be added soon.
