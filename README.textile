MakeRocketGoNow is a 'quicklaunch' plugin fbased on "LibDataBroker-1.1":http://github.com/tekkub/libdatabroker-1-1.
MRGN will take all your LDB launchers and create a LDB plugin to display them in.
This allow you to access to all your LDB launchers on an LDB display addon that doesn't support them.
...
It's highly reccomended that you read the "API documentation":http://github.com/tekkub/libdatabroker-1-1/wikis/api and
